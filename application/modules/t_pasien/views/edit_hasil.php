  ...
  <div id="content">
    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
<form  action="<?php echo base_url('t_pasien/edit_lanjutan') ?>" method="post">
          <table class="table">
            <tr>
              <td>Barcode </td>
            ...
            <tr>
              <td>Hasil </td>
              <td>
                <textarea name="hasil" class="form-control" rows="10" placeholder="Masukan Data Keterangan Dan unggah Data tabel ke google drive Paste di halaman ini....."><?php echo $hasil ?></textarea>
            ...
            <tr>
              <td>Kesimpulan </td>
              <td>
                <textarea name="kesimpulan" class="form-control" rows="10" placeholder="Masukan Data Keterangan Dan unggah Data tabel ke google drive Paste di halaman ini....."> <?php echo $kesimpulan; ?></textarea>
            ...
            <tr>
              <td>Saran </td>
              <td>
                <textarea name="saran" class="form-control" rows="10" placeholder="Masukan Data Keterangan Dan unggah Data tabel ke google drive Paste di halaman ini....."><?php echo $saran ?></textarea>
...
$id_foto =$f->id_foto;
			 ...
			 ?>
			<button type="button"   onclick="remove_image(<?php echo $id_foto;?>)" class="btn btn-danger" name="button"><span class="fa fa-times"></span> Hapus Foto</button>
...
function remove_image(x) {
	...
	type:'POST',
	data: 'id_foto='+x,
	url: '<?php echo base_url('t_pasien/hapus_foto/') ?>',
	dataType:'json',
